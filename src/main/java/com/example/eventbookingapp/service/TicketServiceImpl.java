...
public class TicketServiceImpl implements TicketService{
    ...
    public TicketServiceImpl(ModelMapper modelMapper, TicketRepository ticketRepository, EventRepository eventRepository, EventService eventService) {
    ...
    public AddTicketResponse addTicket(AddTicketRequest addTicketRequest) {
        ...
        newTicket.setDiscount(addTicketRequest.getAmount());
    ...
    @Override
    public Ticket getTicketById(Long eventId, Long ticketId){
